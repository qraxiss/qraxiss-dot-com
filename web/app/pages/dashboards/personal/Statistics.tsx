...
function DollarCoin(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-5 lg:gap-6">
      <Box className="relative flex flex-col rounded-lg bg-linear-to-r from-blue-500 to-indigo-600 px-5 pb-5">
        ...
        <div className="mt-2">
          <Badge
            unstyled
            className="text-xs-plus h-6 rounded-full bg-black/20 px-2 text-white"
          >
            13 Members
          </Badge>
        </div>
        ...
        <Card className="p-4.5">
          <div className="flex min-w-0 items-center justify-between">
            <div>
              ...
              <p className="text-xs-plus truncate">Projects</p>
            </div>
            <Avatar
              size={10}
        ...
        <Card className="p-4.5">
          <div className="flex min-w-0 items-center justify-between">
            <div>
              ...
              <p className="text-xs-plus truncate">Total hours</p>
            </div>
            <Avatar
              size={10}
              initialColor="info"
        ...
        <Card className="p-4.5">
          <div className="flex min-w-0 items-center justify-between">
            <div>
              ...
              <p className="text-xs-plus truncate">Support Ticket</p>
            </div>
            <Avatar
              size={10}
        ...
        <Card className="p-4.5">
          <div className="flex min-w-0 items-center justify-between">
            <div>
              ...
              <p className="text-xs-plus truncate">Active Task</p>
            </div>
            <Avatar
              size={10}
