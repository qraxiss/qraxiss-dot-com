          ...
          >
            <div className="flex min-w-0 items-center gap-2 sm:gap-3">
              ...
              <h2
                className={clsx(
                  isDone && "line-through",
                  "dark:text-dark-100 cursor-pointer truncate font-medium text-gray-800",
                )}
              >
            ...
            <div className="mt-1 flex items-end justify-between">
              <div className="flex flex-wrap items-center gap-1.5 text-xs">
                {dueDate && (
                  <>
                    ...
                    <div className="dark:bg-dark-500 my-0.5 w-px self-stretch bg-gray-200"></div>
                ...
                {labels &&
                  ...
                  labels.map((label, i) => (
                    <Fragment key={label.id}>
                      {(dueDate || i > 0) && (
                        <div className="dark:bg-dark-500 my-0.5 w-px self-stretch bg-gray-200" />
                      )}
                      <span
                        className={`inline-flex items-center gap-2 leading-none this:${label.color}`}
                      >
                        <span className="bg-this dark:bg-this-lighter size-2 rounded-full"></span>
              ...
              <div className="flex items-center gap-1">
                ...
                >
                  {isImportant ? (
                    <StarIconFilled className="text-primary-600 dark:text-primary-400 size-4" />
                  ) : (
                      ...
                      <>
                        <Avatar
                          ...
                          classNames={{
                            ...
                            display:
                              "text-tiny-plus dark:ring-dark-700 ring-1 ring-white",
                          }}
                        />
